...
public class GuiQuanLi extends JFrame implements ActionListener,KeyListener,ItemListener
{
...
//		scrollPane.setBounds(60, 500, 850, 150);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == btnAdd) {
            ...
            record.add(txtMa.getText());
            record.add(txtTen.getText());
            record.add(txtNhan.getText());
            record.add(txtNhacc.getText());
            record.add(txtSoLuong.getText());
            record.add(txtDonGia.getText());
            record.add(txtNgayNhap.getText());
            record.add(txtNgayXuat.getText());
            record.add(txtHanDung.getText());
            record.add(txtTien.getText());
